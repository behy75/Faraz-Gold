...
export function useProfilePage() {
  ...
  const params = useMemo(() => {
    ...
    const tab =
      ...
      (searchParams.get("portfolios_page") ? "portfolios" : "transactions");
    return {
      transactions_page: tp,
      portfolios_page: pp,
      notifications_page: np,
      active_tab: tab,
    };
  }, [searchParams]);
  ...
  return {
    ...
    transactionsPage: data?.transactions_page ?? {
      object_list: [],
      number: 1,
      has_next: false,
      has_previous: false,
    ...
    portfoliosPage: data?.portfolios_page ?? {
      object_list: [],
      number: 1,
      has_next: false,
      has_previous: false,
    ...
    notificationsPage: data?.notifications_page ?? {
      object_list: [],
      number: 1,
      has_next: false,
      has_previous: false,
