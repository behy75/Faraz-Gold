...
export default function UserHeader({
  ...
  const statusText = verificationStatus === 'verified'
      ...
      <div className="col-12 col-lg-6">
        <div className="row g-lg-3 m-0">
          ...
          <div className="col-12 col-lg-7">
            <div className={`${styles.userProfile} d-flex justify-content-between align-items-center`}>
              <div className="d-flex align-items-center">
                <div className={`${styles.userImg} rounded-circle me-3 d-none d-sm-block`}>
                ...
                <div className="d-flex flex-column justify-content-between">
                  ...
                  <div className={styles.infoRow}>
                    <span className="fs-6">
                      موجودی :
                      <span className="ltr ms-1">{formatNumberFa(balance)}</span>
          ...
          <div className="col-12 col-lg-5">
            <div className={`${styles.userLevel} d-flex flex-column justify-content-between`}>
              <div className="d-flex justify-content-between align-items-center mb-2">
                <span className={styles.levelLabel}>سطح کابری</span>
                <a href="/authentication" className="d-flex align-items-center" title="احراز هویت">
                  <span className={styles.levelLink}>احراز هویت</span>
                  <i className="bi bi-chevron-left"></i>
                </a>
              </div>

              <div className={`${styles.levelContainer} d-flex justify-content-between align-items-center w-100`}>
                <div className={`fw-bold ${statusText.klass}`}>
                  {statusText.label}
                  <a href="/authentication" className="d-inline-flex align-items-center ms-2" aria-label="اطلاعات بیشتر">
                ...
                <div className={`${styles.levelTicks} d-none d-md-flex`}>
                  <div className={`${styles.levelSelector} ${['in_review','verified'].includes(verificationStatus) ? styles.active : ''}`}>
                    <span className={styles.center}></span>
                  </div>
                  <div className={`${styles.levelSelector} ${verificationStatus==='verified' ? styles.active : ''}`}>
                    <span className={styles.center}></span>
                  </div>
                </div>
              </div>
          ...
          <div className="col-6">
            <div className={`${styles.statCard} card`}>
              <div className="card-body p-3 d-flex flex-column justify-content-between">
                ...
                <h5 className={`card-title ${totalProfitLoss >= 0 ? 'text-success' : 'text-danger'} text-center`}>
          ...
          <div className="col-6">
            <div className={`${styles.statCard} card`}>
              <div className="card-body p-3 d-flex flex-column justify-content-between">
                ...
                <h5 className="card-title text-white text-center">{formatNumberFa(openTransactionsCount)}</h5>
              </div>
            </div>
          </div>
        </div>
