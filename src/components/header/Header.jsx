      ...
      <nav className={styles.navbar}>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <div className={styles.hamburger}>
            <button
              className={`btn btn-dark ${styles.iconBtn}`}
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M1.5 3.5h13a.5.5 0 010 1h-13a.5.5 0 010-1zm0 4h13a.5.5 0 010 1h-13a.5.5 0 010-1zm0 4h13a.5.5 0 010 1h-13a.5.5 0 010-1z"
                />
              </svg>
            </button>
          </div>
        ...
        <div className={styles.topNav}>
          <ul className={styles.navList}>
            <li>
              <a className={styles.link} href={urls?.marketBase || "/trade/"}>
                بازار
              </a>
            </li>
            <li>
              <a className={styles.link} href={urls?.referral || "/referral/"}>
                دعوت از دوستان
              </a>
            </li>
            <li>
              <a className={styles.link} href={urls?.guides || "/guides/"}>
                راهنمای استفاده
              </a>
            </li>
            <li>
